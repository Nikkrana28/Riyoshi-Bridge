export const RyoshiEthABI = [
  ...
  },
  {
    ...
    name: 'AccidentallySentTokenWithdrawn',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  {
    inputs: [
      { internalType: 'uint8', name: 'newMarketingFee', type: 'uint8' },
      { internalType: 'uint8', name: 'newLiquidityFee', type: 'uint8' },
      { internalType: 'uint8', name: 'newBurnFee', type: 'uint8' },
    ],
    name: 'setFees',
    outputs: [],
    stateMutability: 'nonpayable',
